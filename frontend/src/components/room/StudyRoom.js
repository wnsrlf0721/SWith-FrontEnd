  ...
  const initSocket = () => {
    ...
    socket.on("getOffer", (data) => {
      ...
      if (pc) {
        ...
        setConnectedUserTimer(
          new Map(
            connectedUserTimer.set(data.offerSendID, data.offerStudyTimer)
          )
        );
    ...
    socket.on("getAnswer", (data) => {
      ...
      if (pc) {
        ...
        setConnectedUserTimer(
          new Map(
            connectedUserTimer.set(data.answerSendID, data.answerStudyTimer)
          )
        );
        ...
        <div className="RoomTopBarContainer">
          <div className="ImageContainer">
            ...
            >
              ...
              />
              <div className="textW">{connnectedUsers.length + 1}명</div>
            ...
            <div className="videosWrap">
              <div
                ...
                style={{
                  ...
                  height:
                    "calc(100%/" +
                    SplitScreen(connnectedUsers.length + 1) +
                    ")",
                  width:
                    "calc(100%/" +
                    SplitScreen(connnectedUsers.length + 1) +
